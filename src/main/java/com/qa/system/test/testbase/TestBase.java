package com.qa.system.test.testbase;
...
import com.qa.system.test.helper.browserConfiguration.ChromeBrowser;
import com.qa.system.test.helper.browserConfiguration.FirefoxBrowser;

import com.qa.system.test.helper.browserConfiguration.config.ObjectReader;
import com.qa.system.test.helper.browserConfiguration.config.PropertyReader;
import com.qa.system.test.helper.excel.ExcelHelper;
import com.qa.system.test.helper.javaScript.JavaScriptHelper;
//import com.qa.system.test.helper.javaScript.JavaScriptHelper;
import com.qa.system.test.helper.logger.LoggerHelper;
import com.qa.system.test.helper.resource.ResourceHelper;
import com.qa.system.test.helper.wait.WaitHelper;
import com.qa.system.test.utils.ExtentManager;
...
public class TestBase {
	...
	public String captureScreen(String fileName, WebDriver driver){
	  ...
	  log.info("capturing ui navigation screen..."); new
	  JavaScriptHelper(driver).zoomInBy60Percentage(); String screen =
	  captureScreen("", driver); new
	  JavaScriptHelper(driver).zoomInBy100Percentage(); try {
	  test.addScreenCaptureFromPath(screen); } catch (IOException e) {
	  e.printStackTrace(); } }
	...
	/*
	 * public String getUsername(){ String
	 * username=ObjectReader.reader.getUserName();
	 * logExtentReport("navigating to ..."+username); return username; } public
	 * String getpassword(){ String password=ObjectReader.reader.getPassword();
	 * logExtentReport("navigating to ..."+password); return password;
	 */
	//}
